...
// 위치
function getCoords() {
  // Promise API: 비동기처리 - 데이터 가져올 때까지 기다릴게
...
// height: 모니터 사이즈
// availHeight: 브라우저 크기 (indicator 포함)
